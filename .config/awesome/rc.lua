...
-- enable useless gap and set it to 6px wide
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "🌎", "Code", "3", "4", "5", "6" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, Shift     }, "b",
        function () awful.spawn("/usr/bin/firefox")          end,
    ...
    awful.key({ modkey,           }, "e", 
        function () awful.spawn("/usr/bin/thunar") end,
    ...
    --     function ()
    --         awful.prompt.run {
    --         prompt       = theme.dir .. "/icons/submenu.png",
...
awful.rules.rules = {
    ...
    -- set apps to run in a spcefic workspace
    {
        rule = {class = "Firefox"},
