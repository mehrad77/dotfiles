...
local gears = require("gears"if [[ "$currentime" > "19:00" ]] || [ "$currentime" < "06:30"]; then
...
local guieditor = "codd"
local rofi_run = "rofi -show drun"
...
globalkeys =
    ...
    awful.key(
        ...
        "l",
        function()
            awful.spawn.with_shell(string.format("%s/bin/i3lock %s/.config/awesome/themes/holo/wall.png", os.getenv("HOME"), os.getenv("HOME"), os.getenv("HOME")))
        end,
    ...
    end, {description = "Hibernate System", group = "awesome"}),
    awful.key(
        {altkey, "Shift"},
        "l",
        function()
    ...
    awful.key(
        ...
        {description = "Run rofi luncher ", group = "launcher"}
    ),
    awful.key(
        {modkey},
        "x",
...
awful.rules.rules = {
    ...
    {
        rule_any = {class = {"Skype", "Slack", "Hubstaff"}},
